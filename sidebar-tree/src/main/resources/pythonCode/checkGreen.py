...
def checkGreen(file_folder, file_name):
    ...
    # cv2.imwrite(file_folder+"\\"+file_name+"_jiance.png",yuantu)
    # cv2.imwrite("C:\\Users\\hzaurobot_1\\Desktop\\ruyi\\shibie\\jiance_yuan.jpg",yuantu)
